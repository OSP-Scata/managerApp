...
CREATE  TABLE assessment_manager.t_assessment_status ( 
	a_s_id               integer  NOT NULL ,
...
CREATE  TABLE assessment_manager.t_candidate_status ( 
...
CREATE  TABLE assessment_manager.t_interviewer ( 
...
CREATE  TABLE assessment_manager.t_user ( 
...
CREATE  TABLE assessment_manager.t_assessment ( 
...
COMMENT ON COLUMN assessment_manager.t_assessment.a_date IS 'Assessment date';

CREATE  TABLE assessment_manager.t_candidate ( 
...
CREATE  TABLE assessment_manager.toc_assessment_candidate ( 
	a_c_id               integer   ,
...
CREATE  TABLE assessment_manager.toc_assessment_interviewer ( 
	a_i_id               integer   ,
